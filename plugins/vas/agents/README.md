...
글로벌 VAS를 변경하지 않고 프로젝트에서만 쓸 class/instance를 만들 수 있다:

```
./.agents/
├── vas/state/technique/our-custom-pattern.md      # 프로젝트 전용 STATE
