# Anvil Compilation Specification

anvil-rules.md에서 추출한 컴파일 시맨틱 정의. /anvil-build 스킬의 참조 문서.
...
**오직 `type: instance`이면서 `agent-system: Anvil`인 파일만 컴파일한다.**
...
| 패턴 | 해석 |
|------|------|
| `state/...` | `${CLAUDE_PLUGIN_ROOT}/plugins/anvil/agents/state/...` |
| `act/...` | `${CLAUDE_PLUGIN_ROOT}/plugins/anvil/agents/act/...` |
| `anvil/...` | `${CLAUDE_PLUGIN_ROOT}/plugins/anvil/agents/...` |
| `./...` | 프로젝트 루트 기준 |
| 절대 경로 | 그대로 사용 |
