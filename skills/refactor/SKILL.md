...
> **참조:** 리팩토링 분석 시 `rules/review-guide.md` + `rules/build-guide.md`
...
// 테스트 실행
Bash("yarn test --filter={앱이름} -- --testPathPattern='정책'");
